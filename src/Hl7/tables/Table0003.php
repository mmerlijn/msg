...
class Table0003 extends Table
{
    protected static $name="Event type";
    protected static $table=[
        ...
        "Var"=> "s	MFQ/MFR - Master files query (use event same as asking for e.g., M05 - location)",
        "W01"=> "RU - Waveform result, unsolicited transmission of requested information",
